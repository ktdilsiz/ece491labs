...
module toptestproject();

    logic rxd, clk, rst;
    logic [7:0] data;
    logic cardet, write, error;

    logic switches, btnc, rxd_in, outdata;
    logic [6:0] segs;
    logic [7:0] an;
    logic dp;

    logic jatxd, jtxen, jacardet, jawrite, jaerror;
    logic outja2, outja3, outja4;
 
     	topmodulefinal toplevel(
          .CLK100MHZ(clk),
		  .SW(16'b11111_11111_11111_1),
		  .BTNC(rst),
		  .BTNU(1'b0), 
		  .BTNL(1'b0), 
		  .BTNR(1'b0),
